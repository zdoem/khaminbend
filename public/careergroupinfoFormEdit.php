            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="goccup_name" id="goccup_name" value="<?=$row->goccup_name?>" class="form-control" required  title="กรุณากรอกกลุ่มอาชีพและเป็นตัวเลขเท่านั้น" placeholder="กลุ่มอาชีพ ...">
                </div> 
              </div> 
              <div class="col-md-6">
                <div class="form-group">
                  <label>รายละเอียดพอสังเขป :</label>
                  <textarea class="form-control" name="goccup_desc" id="goccup_desc" rows="2" placeholder="รายละเอียดพอสังเขป  ..."><?=$row->goccup_desc?></textarea>
                </div> 
              </div> 
